...
import { actualiserDossiers, actualiserCorrection, creerDelegation, revoquerDelegation, deciderAmelioration, type EtatAutonomie } from "@/app/actions/autonomie";
...
export function ActualiserCorrection({id}:{id:string}) {return <BoutonAutonomie action={actualiserCorrection.bind(null,id)}>Vérifier l’avancement</BoutonAutonomie>;}
