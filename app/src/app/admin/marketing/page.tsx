...
export default async function PageAgentMarketing() {
  ...
  return <main className="mx-auto w-full max-w-7xl flex-1 space-y-7 p-4 sm:p-7">
    ...
    <section className="grid gap-5 xl:grid-cols-[1.2fr_.8fr]">
      ...
      <div id="programmer" className="section-ecran scroll-mt-6"><div className="entete-carte"><div><p className="libelle-champ">Nouvelle intention</p><h2>Noter une intention éditoriale</h2><p className="mt-1 text-sm leading-relaxed text-[var(--texte-secondaire)]">Le message, l’objectif et la date visée. La publicité payante n’est pas encore ouverte : les droits Meta Ads sont en attente, aucune campagne sponsorisée ne peut être enregistrée ni lancée depuis Gerimmo.</p></div></div><FormulaireCampagne objectifs={OBJECTIFS} /></div>
    </section>
