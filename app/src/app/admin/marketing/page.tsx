  ...
  return <main className="mx-auto w-full max-w-7xl flex-1 space-y-7 p-4 sm:p-7">
    ...
    <div className="entete-page">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <span className="mono-discret">{reglages.actif ? `Brouillons ${jours}, le matin · diffusion après votre accord` : "Préparation des brouillons en pause"}</span>
    ...
    <section className="section-ecran"><div className="entete-carte"><div><p className="libelle-champ">État des connexions</p><h2>Canaux et contrôle</h2><p className="mt-1 text-sm text-[var(--texte-secondaire)]">Les canaux se relient par la configuration du service : variables <code>META_FACEBOOK_PAGE_ID</code> et <code>META_FACEBOOK_PAGE_ACCESS_TOKEN</code> pour la Page, <code>META_AD_ACCOUNT_ID</code> pour la publicité.</p></div></div><div className="mt-4 grid gap-3 sm:grid-cols-3">
    ...
    <details className="section-ecran group"><summary className="cursor-pointer list-none [&::-webkit-details-marker]:hidden"><div className="entete-carte"><div><p className="libelle-champ">Vos possibilités</p><h2>Ce que l’équipe marketing Gerimmo prend en charge</h2></div><span className="lien-discret text-[12.5px]"><span className="group-open:hidden">Afficher</span><span className="hidden group-open:inline">Masquer</span></span></div></summary><div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      ...
      <Capacite icone={<Megaphone className="size-5" />} titre="Diffusion" detail="Préparer deux propositions par semaine. Chaque diffusion dans le journal ou sur Facebook attend votre validation." statut={facebookOperationnel ? "Connectée" : "À finaliser"} operationnel={facebookOperationnel} />
