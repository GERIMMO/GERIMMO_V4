...
export default async function PageAssistance({searchParams}:{searchParams:Promise<{ecran?:string;action?:string;type?:string;sel?:string;vue?:string;page?:string}>}){
 ...
 return <div className="min-h-screen bg-[var(--creme)] text-[var(--encre)]">
  <header className="bg-[var(--encre)] text-[var(--sur-encre)]"><div className="mx-auto flex max-w-5xl items-center justify-between gap-4 p-4"><MarqueGerimmo surEncre/><Link href="/espaces" className="text-sm underline">Mes espaces</Link></div></header>
