...
const QUESTIONS: [string, string][] = [
  ...
  [
    ...
    "Avant toute intervention, votre gestionnaire examine votre demande et vous dit qui paie : le propriétaire, ou vous-même s'il s'agit d'une petite réparation ou de l'entretien courant du logement (par exemple un joint, une ampoule, un siphon à déboucher) — jamais de surprise sur la facture. Vous suivez chaque étape dans « Mes demandes ».",
  ],
  [
