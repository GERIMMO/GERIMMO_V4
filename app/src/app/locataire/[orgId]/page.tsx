...
// grille deux colonnes (mon bail en lignes libellé↔valeur | assurance),
// cartes à liseré gauche porteur de sens.
export default async function PageLocataire(props: PageProps<"/locataire/[orgId]">) {
  ...
  const [{ data: pieces }, { data: baux }, { data: depotRows }] = await Promise.all([
  ...
  return (
    <main className="mx-auto w-full max-w-6xl space-y-[1.125rem] p-4 sm:p-7">
      ...
      <div className="deux-col">
        ...
        {/* Assurance habitation — liseré laiton (obligation annuelle) */}
